    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 mb-5 ftco-animate">
                <a href={{asset('/images/product-1.jpg')}} class="image-popup"><img src={{asset('/images/product-1.jpg')}} class="img-fluid" alt="Colorlib Template"></a>
            </div>
            <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                ...
                <p class="price"><span>${{$product->price*(1-$product->sale)}}</span></p>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="product">
                    <a href="{{route('product-single', $product->id)}}" class="img-prod"><img class="img-fluid" src={{asset('/images/product-1.jpg')}} alt="Colorlib Template">
